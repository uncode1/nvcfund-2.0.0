...
def register_all_modules(app: Flask):
    ...
    try:
        from modules.products import products_bp, cards_payments_bp, insurance_bp, investments_bp, trading_bp
    ...
    # Define all active modules (23 modules with working routes.py files - migrated integrations, api, utils to services container)
    active_modules = [
    ...
    for module_name in active_modules:
        try:
            ...
            # Try shortened name patterns with proper URL prefixes
                ...
                blueprint_found = True
            # Interest rate management integrated into treasury module
    ...
    alias_blueprints = [
        ...
        ('nvct_stablecoin', 'nvct_stablecoin_hyphen_bp'),
