    ...
    def render_dashboard(self, user_role, user=None):
        ...
        try:
            ...
            template_mapping = {
                ...
                'treasury_officer': 'dashboard/treasury_dashboard.html',
                'compliance_officer': 'dashboard/compliance_dashboard.html',
                'institutional_banker': 'dashboard/institutional_dashboard.html',
                'sovereign_banker': 'dashboard/sovereign_dashboard.html',
                'central_banker': 'dashboard/sovereign_dashboard.html',
                'risk_manager': 'dashboard/risk_dashboard.html',
                'loan_officer': 'dashboard/loan_officer_dashboard.html',
                'credit_manager': 'dashboard/loan_officer_dashboard.html',
                'operations_officer': 'dashboard/operations_officer_dashboard.html',
                'operations_manager': 'dashboard/operations_officer_dashboard.html',
                'settlements_officer': 'dashboard/operations_officer_dashboard.html',
                'relationship_manager': 'dashboard/relationship_manager_dashboard.html',
                'branch_manager': 'dashboard/relationship_manager_dashboard.html',
                'banking_officer': 'dashboard/banking_officer_dashboard.html',
                'credit_analyst': 'dashboard/banking_officer_dashboard.html',
                'financial_analyst': 'dashboard/banking_officer_dashboard.html',
                'foreign_exchange_officer': 'dashboard/banking_officer_dashboard.html',
                'trade_finance_officer': 'dashboard/banking_officer_dashboard.html',
                'investment_officer': 'dashboard/banking_officer_dashboard.html'
            }
            
            template = template_mapping.get(user_role_lower, 'dashboard/user_dashboard.html')
