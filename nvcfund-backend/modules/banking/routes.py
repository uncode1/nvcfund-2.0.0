...
from ..core.form_decorators import banking_form, process_form, require_post_data
...
def transfers():
    ...
    try:
        ...
        transfer_history = banking_service.get_transfer_history(current_user.id, limit=20)
        
        context = {
            'accounts': user_accounts,
            'transfer_history': transfer_history,
            'page_title': 'Money Transfers'
        }
        
        return render_template('banking/modular_banking_transfers.html', **context)
        
    except Exception as e:
        error_service.log_error(f"Transfers page error: {str(e)}", current_user.id)
...
def new_transfer():
    ...
    try:
        ...
        return render_template('banking/modular_banking_new_transfer.html', **context)
