...
cards_payments_legacy_bp = Blueprint('cards_payments_legacy', __name__, 
                            template_folder='templates',
                            static_folder='static',
                            url_prefix='/cards_payments')

# Create legacy redirect blueprint for hyphenated URL
cards_payments_hyphen_bp = Blueprint('cards_payments_hyphen', __name__, 
                            template_folder='templates',
                            static_folder='static',
                            url_prefix='/cards-payments')
...
@cards_payments_hyphen_bp.route('/')
@cards_payments_hyphen_bp.route('/card-management')
@login_required
def main_dashboard():
    """Enhanced Cards & Payments main dashboard"""
    try:
...
@cards_payments_hyphen_bp.route('/bill-payment')
@login_required
def bill_payment():
...
@cards_payments_hyphen_bp.route('/process-bill-payment', methods=['POST'])
@login_required  
...
@cards_payments_hyphen_bp.route('/card-controls')
@login_required
def card_controls():
...
@cards_payments_hyphen_bp.route('/update-card-limits', methods=['POST'])
@login_required
...
@cards_payments_hyphen_bp.route('/fraud-monitoring')
@login_required
