...
class LogViewerService:
    ...
    def read_log_content(self, user_role: str, file_path: str, 
        ...
        try:
            ...
            # Apply filters
            filtered_lines = self._apply_filters(lines, filters or {})
    ...
    def _apply_filters(self, lines: List[str], filters: Dict[str, Any]) -> List[Dict[str, Any]]:
        """Apply quality filters to log lines"""
        filtered_lines = []
        ...
        for line_num, line in enumerate(lines, 1):
            ...
            # Parse log line
            parsed_line = self._parse_log_line(line, line_num)
