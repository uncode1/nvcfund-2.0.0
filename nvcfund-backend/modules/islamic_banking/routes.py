...
def main_dashboard():
    ...
    try:
        ...
        return render_template('islamic_banking_dashboard.html',
...
def islamic_products():
    ...
    try:
        ...
        return render_template('islamic_products.html',
                             products_data=products_data)
    except Exception as e:
...
def murabaha_financing():
    ...
    try:
        ...
        return render_template('islamic_murabaha.html',
...
def ijara_leasing():
    ...
    try:
        ...
        return render_template('islamic_ijara.html',
...
def sukuk_management():
    ...
    try:
        ...
        return render_template('islamic_sukuk.html',
...
def profit_sharing():
    ...
    try:
        ...
        return render_template('islamic_profit_sharing.html',
                             pls_data=pls_data)
    except Exception as e:
...
def halal_investments():
    ...
    try:
        ...
        return render_template('islamic_halal_investments.html',
...
def islamic_treasury():
    ...
    try:
        ...
        return render_template('islamic_treasury.html',
...
def zakat_management():
    ...
    try:
        ...
        return render_template('islamic_zakat.html',
