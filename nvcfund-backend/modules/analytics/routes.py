...
# Create blueprint
analytics_main = Blueprint('analytics', __name__, url_prefix='/analytics', template_folder='templates')

# Initialize services
analytics_service = AnalyticsService()
error_logger = ErrorLoggerService()

@analytics_main.route('/')
@analytics_main.route('/dashboard')
@login_required
@admin_access
...
@analytics_main.route('/financial')
@login_required
@admin_access
...
@analytics_main.route('/performance-metrics')
@login_required
@admin_access
...
@analytics_main.route('/user-analytics')
@login_required
@admin_access
def user_analytics():
...
@analytics_main.route('/performance')
@login_required
@admin_access
...
@analytics_main.route('/compliance')
@login_required
@admin_access
...
@analytics_main.route('/executive')
@login_required
@admin_access
...
@analytics_main.route('/real-time')
@login_required
@admin_access
...
@analytics_main.route('/system-monitoring')
@login_required
@admin_access
...
@analytics_main.route('/performance-analysis')
@login_required
@admin_access
...
@analytics_main.route('/network-monitoring')
@login_required
@admin_access
